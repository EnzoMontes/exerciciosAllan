        ...
        public void Executar()
        {
            ...
            switch (ConsultarOpcao)
            {
                ...
                case 7:
                    ...
                    Console.WriteLine("O custo final ao consumidor é:" + model.Exercicio07(custoDeFabrica));
                    break;
                ...
                case 9:
                    Console.WriteLine("Digite o total de macas comprados");
                    double maca = Convert.ToDouble(Console.ReadLine());
                    Console.WriteLine("O total que foi pago é de:" + model.Exercicio09(maca));
                    break;
